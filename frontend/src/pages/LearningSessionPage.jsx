  ...
  return (
    <section className="workspace-page">
      ...
      <article className="panel">
        <div className="panel__header"><div><h3 className="panel__title">{currentProblem.question}</h3><p className="panel__subtitle">유형: {currentProblem.type === 'MULTIPLE' ? '객관식' : '주관식'}</p></div></div>
